...
@CreoleResource(name="WordNet", interfaceName="gate.wordnet.WordNet", comment="WordNet", helpURL="http://gate.ac.uk/userguide/sec:misc-creole:wn", icon="wordnet")
